...
export default function About() {
  return (
    <div className="px-2 py-2">
      <h1 className="text-5xl mb-4 px-4">About</h1>
      <div className="flex flex-col md:flex-row">
        <div className="flex-1/2 px-4 pb-4 md:pb-0">
          <p className="pb-3">
            Ever since discovering programming by accident in elementary school,
            I've been using technology to solve problems and address big
            questions. The last 10 years have been a journey of learning and
            exploring this interest: Along the way, I've automated over 150
            hours of work by writing chatbots, generated three key leads for an
            investigation by visualizing social media data, and taught 10
          ...
          <p className="pb-3">
            ...
            work. If any of what you find seems interesting, let's connect!
          </p>
        </div>

        <div className="flex-1/2 px-4">
          <h2 className="text-3xl">What I'm learning:</h2>
          <ul className="pb-4">
            <li>
          ...
          <h2 className="text-3xl">What I'm doing:</h2>
          <ul className="pb-4">
            <li>
          ...
          <h2 className="text-3xl">What I'm working on:</h2>
          <ul className="pb-4">
            <li>
